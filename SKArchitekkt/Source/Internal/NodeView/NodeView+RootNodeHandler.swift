...
extension NodeView: RootNodeHandler {
    ...
    public func handle(rootNode: Node) {
        ...
        (scene as? NodeScene)?.setColors([
            ...
            "class": #colorLiteral(red: 0, green: 0.4501332641, blue: 0.7726731896, alpha: 1),
            "": #colorLiteral(red: 0.9584057927, green: 0.4752865434, blue: 0.123818852, alpha: 1),
            "4": #colorLiteral(red: 0.0007383706979, green: 0.7139746547, blue: 0.6165400147, alpha: 1),
            "variable": #colorLiteral(red: 0.4512139559, green: 0.1424450874, blue: 0.5111054778, alpha: 1),
            "sourceFile": #colorLiteral(red: 0.08871147782, green: 0.6160094738, blue: 0.3655350804, alpha: 1),
            "7": #colorLiteral(red: 0.3293760121, green: 0.329436779, blue: 0.3293679655, alpha: 1),
            "function": #colorLiteral(red: 0.9182413816, green: 0.6399110556, blue: 0.1377894878, alpha: 1),
